...
kk = LINETCR.LINE() #Luffy
kk.login(qr=True)
kk.loginResult()

kc = LINETCR.LINE() #Luffy
kc.login(qr=True)
kc.loginResult()
...
Bots=[mid,"u95b2e9d6cb4d2af7786116bcffa70c30","u67a4dfd5347dc4c6e447704b4a0467e3","u9368d6b1b87571ef98b6053eb31dbfc4","u989d5155c18b69bb6aa26663e3081e04","u1ba939e86c26deb3906a463daf99f12e","u54a05ec0f2c42080975cde56c9338e34","uf1e4c91fbba915ce4d75206b17f60786"]
admin=["u95b2e9d6cb4d2af7786116bcffa70c30","u67a4dfd5347dc4c6e447704b4a0467e3","u9368d6b1b87571ef98b6053eb31dbfc4","u989d5155c18b69bb6aa26663e3081e04","u1ba939e86c26deb3906a463daf99f12e","u54a05ec0f2c42080975cde56c9338e34","uf1e4c91fbba915ce4d75206b17f60786"]
cl.login(qr=True)
cl.loginResult()
...
wait = {
  ...
  BOT PROTECT
Idline: http://line.me/ti/p/~22_26_27""",
    "lang":"JP",
        ...
        if op.type == 13:
          if wait["Protectcancl"] == True:
            ...
            if op.param2 in admin:
              ...
              random.choice(KAC).sendText(op.param1, "⚠Please contact Owner : zall ⚠")
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "👉Marsha Bot👈\nBerikut Adalah Anggota yang sedang Aktif%s\n\n\n>Baru Saja Menyimak<\n%s-=👀👀👀👀👀👀=-\n\n\n👉Support by👈\n👉Enemy Bot Protect\n👉Afterlost Bot Protect\n👉Eyes Bot Protect\n\n👉Owner : Zall👈\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "🏃🏃🏃🏃🏃🏃🏃🏃🏃🏃")
#-----------------------------------------------
...
#-----------------------------------------------
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'u95b2e9d6cb4d2af7786116bcffa70c30'}
              cl.sendText(msg.to,"⚠⚠⚠⚠⚠⚠⚠⚠⚠")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"⚠⚠⚠⚠⚠⚠⚠⚠⚠")
              cl.sendText(msg.to,"⚠Marsha Bot⚠\n⚠By : Zall⚠")
